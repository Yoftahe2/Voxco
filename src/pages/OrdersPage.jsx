            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        <img src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Port IN" className="w-full h-48 object-cover" />
                        <div className="p-6">
                    ...
                    {/* Port Out Card */}
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Port Out" className="w-full h-48 object-cover" />
                        <div className="p-6">
                    ...
                    {/* SIPTRUNK Card */}
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        <img src="https://images.unsplash.com/photo-1556656793-08538906a9f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="SIPTRUNK" className="w-full h-48 object-cover" />
                        <div className="p-6">
                ...
                {/* Additional Images Section - Gallery */}
                {/* <section className="grid md:grid-cols-4 gap-4 mt-16">
                    <img src="/image5.svg" alt="Image 5" className="rounded-lg shadow-md" />
                    <img src="/image6.png" alt="Image 6" className="rounded-lg shadow-md" />
                    <img src="/image7.svg" alt="Image 7" className="rounded-lg shadow-md" />
                    <img src="/image8.jpg" alt="Image 8" className="rounded-lg shadow-md" />
                </section> */}
            </div>
        </main>
    );
